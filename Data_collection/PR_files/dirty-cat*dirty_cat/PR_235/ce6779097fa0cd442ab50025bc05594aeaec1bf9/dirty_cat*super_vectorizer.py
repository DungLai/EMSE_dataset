...
class SuperVectorizer(ColumnTransformer):
    ...
    handle_unknown: {'error', 'ignore'}, default='error'
        ...
        For OneHotEncoder or TargetEncoder, when this parameter is set to âignoreâ and
        an unknown category is encountered during transform, the resulting one-hot encoded
        columns for this feature will be all zeros.
        For OrdinalEncoder, when this parameter is set to âignoreâ and an unknown category is
