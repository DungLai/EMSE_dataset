...
class AutoCorrelationTransformer(BaseTransformer):
    ...
    missing : {"none", "raise", "conservative", "drop"}, default="none"
        ...
        - âraiseâ raises an exception if NaN values are found.
        - âdropâ removes the missing observations and then estimates the
          autocovariances treating the non-missing as contiguous.
        - âconservativeâ computes the autocovariance using nan-ops so that nans
