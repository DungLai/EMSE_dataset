...
__author__ = ['Markus LÃ¶ning', 'Sajay Ganesh', 'big-o@github']
...
def load_lynx():
    ...
    Details
    -------
    The annual numbers of lynx trappings for 1821â1934 in Canada. This time-series records the number of skins of
    ...
    annual Canadian lynx trappings for the years 1821â1934 and a new analysis. Journal of the Royal Statistical Society
