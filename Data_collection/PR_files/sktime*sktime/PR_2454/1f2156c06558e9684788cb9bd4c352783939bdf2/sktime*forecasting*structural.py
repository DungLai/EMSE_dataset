...
class UnobservedComponents(_StatsModelsAdapter):
    ...
    References
    ----------
    .. [1] Seabold, Skipper, and Josef Perktold. âstatsmodels: Econometric
       and statistical modeling with python.â Proceedings of the 9th Python
    ...
    def _predict_interval(self, fh, X=None, coverage=0.90):
        ...
        for c in coverage:
            ...
            pred_int[(c, "upper")] = pred_statsmodels["mean_ci_lower"].loc[
                valid_indices
            ]
