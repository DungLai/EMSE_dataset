...
class TabularToSeriesAdaptor(_SeriesToSeriesTransformer):
    """Adaptor for scikit-learn-like tabular transformers to series
    setting.

    This is useful for applying scikit-learn transformers to series,
    but only works with transformers that do not require multiple instances for fitting.
