...
class AutoARIMA(_OptionalForecastingHorizonMixin, _SktimeForecaster):
    ...
    KwiatkowskiâPhillipsâSchmidtâShin, Augmented Dickey-Fuller or
    PhillipsâPerron) to determine the order of differencing, d, and then
    ...
    information_criterion, one of (âaicâ, âaiccâ, âbicâ, âhqicâ, âoobâ)
    (Akaike Information Criterion, Corrected Akaike Information Criterion,
    Bayesian Information Criterion, Hannan-Quinn Information Criterion, or
    âout of bagââfor validation scoringârespectively) and returns the ARIMA
    ...
    start_p : int, optional (default=2)
        ...
        of the auto-regressive (âARâ) model. Must be a positive integer.
    d : int, optional (default=None)
        ...
        either the KwiatkowskiâPhillipsâSchmidtâShin, Augmented Dickey-Fuller
        or the PhillipsâPerron test will be conducted to find the most probable
        value). Must be a positive integer or None. Note that if d is None,
        the runtime could be significantly longer.
    start_q : int, optional (default=2)
        The starting value of q, the order of the moving-average (âMAâ) model.
    ...
    information_criterion : str, optional (default='aic')
        ...
        pmdarima.arima.auto_arima.VALID_CRITERIA, (âaicâ, âbicâ, âhqicâ,
        âoobâ).
    ...
    n_jobs : int, optional (default=1)
        ...
        (stepwise=False). Default is 1, but -1 can be used to designate âas
        many as possibleâ.
    ...
    error_action : str, optional (default='warn')
        ...
        (âwarnâ), raise the ValueError (âraiseâ) or ignore (âignoreâ). Note
    ...
    random : bool, optional (default='False')
        ...
        perform a ârandom searchâ over a hyper-parameter space. If random is
    ...
    n_fits : int, optional (default=10)
        If random is True and a ârandom searchâ is going to be performed,
        n_iter is the number of ARIMA models to be fit.
    out_of_sample_size : int, optional (default=0)
        The ARIMA class can fit only a portion of the data if specified, in
        order to retain an âout of bagâ sample score. This is the number of
        ...
        the observations will be added into the modelâs endog and exog arrays
    ...
    scoring : str, optional (default='mse')
        ...
        to use for scoring the out-of-sample data. One of (âmseâ, âmaeâ)
...
class ARIMA(_OptionalForecastingHorizonMixin, _SktimeForecaster):
    """An ARIMA estimator.
