...
class VectorAutoRegression(_StatsModelsAdapter):
    ...
    freq: str, optional (default=None)
        ...
        Pandas offset or âBâ, âDâ, âWâ, âMâ, âAâ, or âQâ.
    ...
    Two canonical VARMA forms: Scalar component models vis-Ã -vis the echelon form.
    Econometric Reviews, 31(1), 60â83, 2012.
