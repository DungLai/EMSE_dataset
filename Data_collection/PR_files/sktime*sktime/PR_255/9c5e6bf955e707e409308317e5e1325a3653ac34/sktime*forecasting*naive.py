...
class NaiveForecaster(OptionalForecastingHorizonMixin, BaseLastWindowForecaster):
    ...
    strategy : str{"last", "mean", "seasonal_last"}, optional (default="last")
        ...
        * "seasonal_last": forecasts  last value of the same season in the training series
        * "seasonal_mean": forecasts the mean of  last value of the same season in the training series
