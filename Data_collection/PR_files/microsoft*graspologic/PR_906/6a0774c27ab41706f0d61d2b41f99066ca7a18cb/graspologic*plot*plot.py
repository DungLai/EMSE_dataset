...
def networkplot(
    ...
    legend: None (default), or one of {brief, full, auto}
        How to draw the legend. If âbriefâ, numeric hue and size variables
        will be represented with a sample of evenly spaced values. If âfullâ,
        every group will get an entry in the legend. If âautoâ, choose
