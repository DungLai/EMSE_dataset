...
class GraphMatch(BaseEstimator):
    ...
    init : string (default = 'barycenter') or 2d-array
        ...
        "barycenter" : the non-informative âflat doubly stochastic matrix,â
    ...
    .. [1] J.T. Vogelstein, J.M. Conroy, V. Lyzinski, L.J. Podrazik, S.G. Kratzer,
        E.T. Harley, D.E. Fishkind, R.J. Vogelstein, and C.E. Priebe, âFast
        approximate quadratic programming for graph matching,â PLOS one, vol. 10,
