...
def build_label_file_list(label_file_list,
    ...
    label_file_colour_map: {722716: {a: 1, hex: "#1BFC8C", hex8: "#1BFC8CFF",â¦},â¦}
...
def new_or_update_core(session,
    ...
    Assumption is data âflowsâ
    We expect more data to be added to a userâs original directory after job is created
    Can merge files fairly easily in theory but canât go back in time and undo if it doesnât exist in the first place
