...
class DiffgramInstallTool:
    ...
    def populate_env(self):
        ...
        text_file.close()
        bcolors.printcolor('â Environment file written to: {}'.format(os.path.abspath(text_file.name)), bcolors.OKGREEN)        
    ...
    def launch_dockers(self):
        try:
            ...
            print('â Diffgram Successfully Launched!')
        ...
        if local_database == 'y' or local_database == '':
            ...
            while not valid:
                ...
                try:
                    ...
                    bcolors.printcolor('â DB connection succesful!', bcolors.OKGREEN)
                    time.sleep(2)
                except Exception as e:
                    bcolors.printcolor(
