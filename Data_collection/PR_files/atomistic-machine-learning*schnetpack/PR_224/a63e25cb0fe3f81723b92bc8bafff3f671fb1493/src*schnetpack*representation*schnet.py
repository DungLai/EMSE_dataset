...
class SchNet(nn.Module):
    ...
    References:
    .. [#schnet1] SchÃ¼tt, Arbabzadah, Chmiela, MÃ¼ller, Tkatchenko:
       Quantum-chemical insights from deep tensor neural networks.
       Nature Communications, 8, 13890. 2017.
    .. [#schnet_transfer] SchÃ¼tt, Kindermans, Sauceda, Chmiela, Tkatchenko, MÃ¼ller:
       SchNet: A continuous-filter convolutional neural network for modeling quantum
       interactions.
       In Advances in Neural Information Processing Systems, pp. 992-1002. 2017.
    .. [#schnet3] SchÃ¼tt, Sauceda, Kindermans, Tkatchenko, MÃ¼ller:
