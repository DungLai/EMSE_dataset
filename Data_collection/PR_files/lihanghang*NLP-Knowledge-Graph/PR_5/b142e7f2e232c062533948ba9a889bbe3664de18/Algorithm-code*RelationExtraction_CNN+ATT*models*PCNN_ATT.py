...
'''
References:
ãNeural Relation Extraction with Selective Attention over Instancesã--PCNN+ATT(2016)
ãDistant Supervision for Relation Extraction via PiecewiseãConvolutional Neural Networksã--PCNN(2015)
'''
