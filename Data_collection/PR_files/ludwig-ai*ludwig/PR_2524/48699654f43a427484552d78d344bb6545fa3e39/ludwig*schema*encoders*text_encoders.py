...
class ALBERTConfig(BaseEncoderConfig):
    ...
    intermediate_size: int = schema_utils.PositiveInteger(
        default=16384,
        description="The dimensionality of the âintermediateâ (often named feed-forward) layer in the Transformer "
        "encoder.",
...
class BERTConfig(BaseEncoderConfig):
    ...
    intermediate_size: int = schema_utils.PositiveInteger(
        default=3072,
        description="Dimensionality of the âintermediateâ (often named feed-forward) layer in the Transformer encoder.",
...
class TransformerXLConfig(BaseEncoderConfig):
    ...
    d_model: int = schema_utils.PositiveInteger(
        default=1024,
        description="Dimensionality of the modelâs hidden states.",
    ...
    d_head: int = schema_utils.PositiveInteger(
        default=64,
        description="Dimensionality of the modelâs heads.",
...
class XLNetConfig(BaseEncoderConfig):
    ...
    mem_len: int = schema_utils.PositiveInteger(
        ...
        "previous forward pass wonât be re-computed. ",
...
class DistilBERTConfig(BaseEncoderConfig):
    ...
    hidden_dim: int = schema_utils.PositiveInteger(
        default=3072,
        description="The size of the âintermediateâ (often named feed-forward) layer in the Transformer encoder.",
...
class ELECTRAConfig(BaseEncoderConfig):
    ...
    intermediate_size: int = schema_utils.PositiveInteger(
        default=1024,
        description="Dimensionality of the âintermediateâ (i.e., feed-forward) layer in the Transformer encoder.",
