...
class BaseTrainerConfig(schema_utils.BaseMarshmallowConfig, ABC):
    ...
    eval_batch_size: Union[None, int, str] = schema_utils.OneOfOptionsField(
        ...
        description=(
            ...
            "memory is available. If âautoâ, the biggest batch size (power of 2) that can fit in memory will be used."
        ),
...
class ECDTrainerConfig(BaseTrainerConfig):
    ...
    batch_size: Union[int, str] = schema_utils.OneOfOptionsField(
        ...
        allow_none=False,
        description=(
            "The number of training examples utilized in one training step of the model. If âautoâ, the "
