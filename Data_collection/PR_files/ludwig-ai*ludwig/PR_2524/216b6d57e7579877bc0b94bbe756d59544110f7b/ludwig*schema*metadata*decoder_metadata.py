...
DECODER_METADATA = {
    ...
    "SequenceGeneratorDecoder": {
        ...
        "reduce_input": ParameterMetadata(
            ...
            related_parameters=None,
            other_information=None,
            description_implications="âlastâ: Reduces tensor by taking the last non-zero element per sequence in the "
            "sequence dimension.\nâsumâ: Reduces tensor by summing across the sequence "
            "dimension.\nâmeanâ: Reduces tensor by taking the mean of the sequence "
            "dimension.\nâavgâ: synonym for âmeanâ.\nâmaxâ: Reduces tensor by taking the "
