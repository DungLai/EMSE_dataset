...
class Mask:
    ...
    def union(self, other):
        """
        Unites the array of the specified mask with this maskâs array and returns the result as a new mask.
    ...
    def intersect(self, other):
        """
        Intersects the array of the specified mask with this masksâs array
    ...
    def subtract(self, other):
        """
        Subtracts the array of the specified mask from this masksâs array and
