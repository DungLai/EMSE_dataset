...
class CJKChars(object):
    ...
    # Kangxi Radicals (2F00â2FDF)
    # Ideographic Description Characters (2FF0â2FFF)
    # CJK Symbols and Punctuation (3000â303F)
    # Hiragana (3040â309F)
    # Katakana (30A0â30FF)
    # Bopomofo (3100â312F)
    # Hangul Compatibility Jamo (3130â318F)
    # Kanbun (3190â319F)
    # Bopomofo Extended (31A0â31BF)
    # CJK Strokes (31C0â31EF)
    # Katakana Phonetic Extensions (31F0â31FF)
    # Enclosed CJK Letters and Months (3200â32FF)
    # CJK Compatibility (3300â33FF)
    # CJK Unified Ideographs Extension A (3400â4DBF)
    # Yijing Hexagram Symbols (4DC0â4DFF)
    # CJK Unified Ideographs (4E00â9FFF)
    # Yi Syllables (A000âA48F)
    # Yi Radicals (A490âA4CF)
    ...
    # CJK Compatibility Ideographs (F900âFAFF)
    CJK_Compatibility_Ideographs = (63744, 64255)  # (ord(u"\uF900"), ord(u"\uFAFF"))

    # CJK Compatibility Forms (FE30âFE4F)
    CJK_Compatibility_Forms = (65072, 65103)  # (ord(u"\uFE30"), ord(u"\uFE4F"))

    # Range U+FF65âFFDC encodes halfwidth forms, of Katakana and Hangul characters
    Katakana_Hangul_Halfwidth = (65381, 65500)  # (ord(u"\uFF65"), ord(u"\uFFDC"))

    # Ideographic Symbols and Punctuation (16FE0â16FFF)
    ...
    # Supplementary Ideographic Plane (20000â2FFFF)
