...
class Spell(abc.ABC):
    ...
    @staticmethod
    def cast(on, df, source_table, feature_name, column=None, within=10 * 1000, **kwargs):
        ...
        df : pandas.DataFrame
            ...
            own column by setting the :code:`column` parameter.
        source_table : str
            BigQuery table to run queries against.
        feature_name : str
            Column name for the output feature.
        column : str, optional
            Column to look for the geometries. The default is :code:`None`
