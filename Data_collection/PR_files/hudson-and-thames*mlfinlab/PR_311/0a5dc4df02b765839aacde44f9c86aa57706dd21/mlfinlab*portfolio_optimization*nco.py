...
class NCO:
    ...
    modification from the following paper: `Marcos Lopez de Prado âA Robust Estimator of the Efficient Frontierâ,
    ...
    def allocate_nco(self, cov, mu_vec=None, max_num_clusters=None, n_init=10):
        ...
        :param mu_vec: (np.array) Expected value of draws from the variables for maximum Sharpe ratio.
                              None if outputting the minimum variance portfolio.
        :param max_Ñum_Ñlusters: (int) Allowed maximum number of clusters. If None then taken as num_elements/2.
