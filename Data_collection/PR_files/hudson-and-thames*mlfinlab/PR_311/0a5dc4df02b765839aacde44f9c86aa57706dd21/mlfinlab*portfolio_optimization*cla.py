...
class CriticalLineAlgorithm:
    ...
    modification from the following paper: `D.H. Bailey and M.L. Prado âAn Open-Source Implementation of the Critical- Line
    Algorithm for Portfolio Optimizationâ,Algorithms, 6 (2013), 169-196. <http://dx.doi.org/10.3390/a6010169>`_.
