...
class RiskEstimators:
    ...
    Marcos Lopez de Prado âMachine Learning for Asset Managersâ, (2020).
    """
    ...
    def minimum_covariance_determinant(returns, price_data=False, assume_centered=False,
        ...
        "The idea is to find a given proportion (h) of âgoodâ observations that are not outliers
    ...
    def empirical_covariance(returns, price_data=False, assume_centered=False):
        ...
        Estimator of a sample is an unbiased estimator of the corresponding populationâs covariance matrix".
