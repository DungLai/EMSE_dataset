...
def ml_get_train_times(info_sets: pd.Series, test_times: pd.Series) -> pd.Series:  # pragma: no cover
    ...
    âoverlap.index: Time when the information extraction started.
    âoverlap.value: Time when the information extraction ended.
    âtest_times: Times for the test dataset.
    """
...
class PurgedKFold(KFold):
    ...
    def __init__(self, n_splits=3, info_sets=None, pct_embargo=0.):
        ...
        :param info_sets:
            âinfo_sets.index: Time when the information extraction started.
            âinfo_sets.value: Time when the information extraction ended.
