...
class OLPS:
    ...
    Traditional theories for portfolio selection, such as Markowitzâs Modern Portfolio Theory,
    ...
    Dr. Bin Li and Dr. Steven Hoiâs book, Online Portfolio Selection: Principles and Algorithms,
    ...
    def _print_progress(self, iteration, prefix='', suffix='', decimals=1, bar_length=50):
        ...
        # Fill the bar.
        block = 'â' * filled_length + '-' * (bar_length - filled_length)
        # Print new line.
