...
def get_daily_vol(close, lookback=100):
    ...
    in a bet. Otherwise, sometimes we will be aiming too high (tao â« sigma_t_i,0), and sometimes too low
    (tao âª sigma_t_i,0 ), considering the prevailing volatility. Snippet 3.1 computes the daily volatility
